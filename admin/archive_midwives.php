...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<a class='btn btn-sm btn-success btn-restore' href='#' data-toggle='modal' data-target='#restoreModal' data-id='" . htmlspecialchars($row['midwife_id']) . "'  data-toggle='tooltip' title='Restore'><i class='fa fa-undo'></i> Restore</a>";

        echo "<a class='btn btn-sm btn-danger' href='#' data-toggle='modal' data-target='#delete' data-id='" . htmlspecialchars($row['midwife_id']) . "'  data-toggle='tooltip' title='Delete Permanently'><i class='fa fa-trash'></i></a>";
        echo "</td>";
        echo "</tr>";
    }
} else {
