...
<html lang="en">
  <head>
    ...
    <script>
        // Function to display a message box and then redirect
        function showSuccessMessage(message) {
            alert(message);
            window.location.href = '/MRM/admin/midwives.php';
        }
        ...
        window.onload = function() {
            ...
            if (message === 'archived_successfully') {
                showSuccessMessage('Midwife archived successfully.');
            }
        };
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Midwives</li>
                </ol>
              </div>
              <!-- /.col -->
              <a
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h3>Are you sure you want to archive this Midwife?</h3>
                <form id="deleteForm" method="POST" action="archive_midwife.php">
                    <input type="hidden" name="midwife_id" id="midwife_id_to_delete" />
                    <div class="m-t-20">
...
<div id="edit" class="modal animated rubberBand delete-modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body text-center">
                <form action="edit_midwife.php" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
...
<script>
// JavaScript to set the midwife ID in the delete form
document.querySelectorAll('[data-target="#delete"]').forEach(button => {
    button.addEventListener('click', function () {
        const midwifeId = this.getAttribute('data-id');
        document.getElementById('midwife_id_to_delete').value = midwifeId;
    });
});
</script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (message === 'archived') {
        // Show success alert
        alert('The midwife record has been archived successfully.');
        
        // Redirect or refresh the page after the alert
        setTimeout(function() {
